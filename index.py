...
from flask import Flask, render_template, request
from modelos.mean_squares import make_iteration, calculate_ni as ms_calculate_ni
from modelos.linear_congruence import calculate_table as lc_calculate_table
from modelos.multiplicative_congruence import calculate_method as mc_calculate_method
from modelos.uniform_distribution import uniform_distribution as ud_uniform_distribution
from modelos.normal_distribution import normal_distribution as nd_normal_distribution
from modelos.distribution import calculate_interval, generate_plot
...
def multiplicative_congruence_calculate():
    ...
    max_value = int(request.form["max-value"])
    # Calculamos la tabla con los valores de las columnas
    table = mc.calculate_method(
        x0, 8 * t + 3, 2**g, iteraciones, min_value, max_value)
    # Guardamos los valores ni en variables globales para poder acceder a ellos desde las funciones de plot
...
def uniform_distribution_calculate():
    ...
    ri_array, ni_array = ud.uniform_distribution(
        iterations, max_value, min_value)
    # Guardamos los valores ni en variables globales para poder acceder a ellos desde las funciones de plot
